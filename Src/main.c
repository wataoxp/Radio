...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
const char UpperStr[] = "Select Menu";
const char LowerStr[] = "Tune  Seek  Freq";
/* USER CODE END 0 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  GPIO_InitStruct.Pin = STC_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
  LL_GPIO_Init(STC_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(STOP_GPIO_Port, STOP_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(BACK_GPIO_Port, BACK_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(LEFT_GPIO_Port, LEFT_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(CENTER_GPIO_Port, CENTER_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(RIGHT_GPIO_Port, RIGHT_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(STOP_GPIO_Port, STOP_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(BACK_GPIO_Port, BACK_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(LEFT_GPIO_Port, LEFT_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(CENTER_GPIO_Port, CENTER_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(RIGHT_GPIO_Port, RIGHT_Pin, LL_GPIO_MODE_INPUT);
